...
public class HotGroundState extends MiniGame {
    ...
    private final Map<Block, Integer> blocksToRemove;
    private final List<Block> blocksToRemoveToRemove;
    ...
    protected void startMiniGame() {
        gameTask = new BukkitRunnable() {
            ...
            public void run() {
                ...
                if (plugin.getPlayers().size() == (diePlayers.size() + 1) || plugin.getPlayers().size() == 1 ||
